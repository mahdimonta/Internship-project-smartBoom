...
import smartboom.composeapp.generated.resources.phone_number
import smartboom.composeapp.generated.resources.phone_number_empty_error
import smartboom.composeapp.generated.resources.phone_number_incorrect_error
import smartboom.composeapp.generated.resources.privacy
import smartboom.composeapp.generated.resources.privacy_description
...
@Composable
fun SignUp(navigateTo: (String) -> Unit) {
    ...
    Column(
        ...
        Column {
            ...
            CustomTextField(
                ...
                phone,
                {
                    ...
                    phoneError = phone.firstOrNull() != '0' || phone == ""
                },
                shape = RoundedCornerShape(12.dp),
                leadingIcon = {
                    Icon(
                        modifier = Modifier.size(45.dp).padding(start = 10.dp).fillMaxWidth(),
                        painter = painterResource(Res.drawable.phone_ic),
                ...
                errorText = if (phoneError) {
                    if (phone == "") {
                        stringResource(Res.string.phone_number_empty_error)
                    } else {
                        if (phone.firstOrNull() != '0')
                            stringResource(Res.string.phone_number_incorrect_error)
                        else
                            null
                    }
            ...
            Row(
                ...
                Text(
                    stringResource(Res.string.privacy_description),
                    fontSize = 15.sp,
                    color = Color.Black,
                    fontWeight = FontWeight.Bold
        ...
        Column(
            ...
            Button(
                onClick = {
                    navigateTo(Routes.Verification.route)
                },
